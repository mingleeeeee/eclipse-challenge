...
const initialSystemMessage = {
  role: "system",
  content: "You are supposed to discuss philosophy deeply. Please share a philosophic sentence after user say hi to you. You cannot do other things not related to this.\
              ...
              <div key={index} className={`flex ${msg.role === "user" ? "justify-end" : "justify-start"}`}>
                {msg.role === "assistant" && (
                  <div className="flex items-start">
                    <Image
                      src="/OG-philosophy-discuss.webp"
