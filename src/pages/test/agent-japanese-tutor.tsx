...
// Initial system message for the Japanese tutor bot
const initialSystemMessage = {
  role: "system",
  content: "You are a helpful assistant that provides detailed and accurate lessons on Japanese. Basically you should provide short story in japanese while teaching. \
  You are able to speak both Japanese and English. You cannot do other things not related to this.",
};
...
// Main component for the Japanese tutor bot
