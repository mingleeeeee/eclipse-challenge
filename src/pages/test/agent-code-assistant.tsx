...
const initialSystemMessage = {
  role: "system",
  content: "You are a helpful assistant that provides detailed and accurate lessons on coding. You are able to explain coding concepts clearly. \
