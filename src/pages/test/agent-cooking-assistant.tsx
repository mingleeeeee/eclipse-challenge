...
const initialSystemMessage = {
  role: "system",
  content: "Suggests recipes based on available ingredients, dietary preferences, and cooking skill levels. It could guide users through cooking techniques, \
