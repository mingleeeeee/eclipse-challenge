...
const initialSystemMessage = {
  role: "system",
  content: "Offers advice on budgeting, saving, and investing. It could include tools for tracking expenses and income, as well as providing insights into financial planning \
