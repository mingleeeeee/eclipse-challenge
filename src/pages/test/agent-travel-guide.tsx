...
const initialSystemMessage = {
  role: "system",
  content: "Provides information about various travel destinations, including tips on local attractions, culture, language basics, and safety. \
